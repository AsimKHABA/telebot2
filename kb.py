...
iexit_kb = InlineKeyboardMarkup(inline_keyboard=[[KeyboardButton(text="⬅️ Выйти в меню", callback_data="menu")]])
...
builder.adjust(2)
await message.answer("Текст сообщения", reply_markup=builder.as_markup())